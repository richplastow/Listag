...
var Listag, SomeClass, Tudor, _o, _oT, _oV, tudor,
...
SomeClass = (function() {
  ...
  function SomeClass(config) {
    ...
    M = "/listag/src/SomeClass/SomeClass.litcoffee SomeClass()\n  ";
    this.x = null;
  }

  SomeClass.prototype.xx = function(yy) {
    var M;
    return M = "/listag/src/SomeClass/SomeClass.litcoffee SomeClass::xx()\n  ";
  };
...
tudor.add([
  "01 Listag Constructor", tudor.is, "The class and instance are expected types", "The Listag class is a function", _o.F, function() {
    return Listag;
