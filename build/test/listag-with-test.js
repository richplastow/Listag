...
(function(_oG) {
/*! Listag 0.0.8 //// MIT Licence //// http://listag.richplastow.com/ */
...
tudor.add([
  ...
  }, "'node' `total`, `head`, `tail`, `previous` and `next` as expected", tudor.equal, "13 nodes created during the '02 Listag::add()' test", 13, function(listag) {
