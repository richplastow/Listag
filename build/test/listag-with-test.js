...
var ID_RULE, Listag, Node, TAG_RULE, Tudor, oo, tudor,
...
tudor.add([
  "05 Listag::browse()", tudor.is, "`browse()` is a function which returns a string", function() {
    return [new Listag];
  ...
  }, "For a populated Listag instance, `browse()` returns a table, as a string", "..................aa..bbbb\nthe_1st  boolean  x   x   ", function(listag) {
    listag.add(true, 'the_1st', ['aa', 'bbbb']);
    return listag.browse();
  }, "The `config` argument accepts an object as expected", "Empty object", ".....................aa..bbbb..ccc\nthe_1st     boolean  x   x        \nthe_second  number       x     x  \nthird       array                 \nfourth      regexp             x  ", function(listag) {
    listag.add(222, 'the_second', ['bbbb', 'ccc']);
    listag.add([3], 'third');
    listag.add(/4/, 'fourth', ['ccc']);
    return listag.browse({});
  }, "Can contain arbitrary properties", ".....................aa..bbbb..ccc\nthe_1st     boolean  x   x        \nthe_second  number       x     x  \nthird       array                 \nfourth      regexp             x  ", function(listag) {
    return listag.browse({
      a: 1,
      '-!•': 'ok'
    });
  }, "Can be `null`", ".....................aa..bbbb..ccc\nthe_1st     boolean  x   x        \nthe_second  number       x     x  \nthird       array                 \nfourth      regexp             x  ", function(listag) {
    return listag.browse(null);
  }, "Can be `undefined`", ".....................aa..bbbb..ccc\nthe_1st     boolean  x   x        \nthe_second  number       x     x  \nthird       array                 \nfourth      regexp             x  ", function(listag) {
  ...
  }, "`config.format` usage", tudor.equal, "The string 'text'", "....................bbbb..ccc\nthe_second  number  x     x  \nthird       array            \nfourth      regexp        x  ", function(listag) {
