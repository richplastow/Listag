...
(function(global) {
/*! Listag 0.0.17 //// MIT Licence //// http://listag.richplastow.com/ */
...
Listag = (function() {
  ...
  Listag.prototype.browse = function(config) {
    var M, aToZtags, j, k, len, len1, len2, m, maxI, maxId, maxType, meta, node, out, ref, row, t, v;
    if (config == null) {
      config = {};
    }
    ...
    maxI = (this.total.node + '').length;
    row = oo.pad('i', maxI + 2, '.') + oo.pad('id', maxId + 2, '.') + oo.pad('type', maxType, '.');
    ...
    for (k = 0, len1 = meta.length; k < len1; k++) {
      node = meta[k];
      row = oo.pad(node.i + '', maxI) + '  ' + oo.pad(node.id, maxId) + '  ' + oo.pad(node.type, maxType);
...
summarizeNodes = function(node) {
  var M, aToZtags, i, maxId, maxType, meta, metaTags, tag, type;
  ...
  while (node) {
    ...
    metaTags = {};
    for (tag in node.next) {
      aToZtags[tag] = aToZtags[tag] ? aToZtags[tag] + 1 : 1;
...
summarizeAndFilterNodes = function(node, tags) {
  var M, aToZtags, i, j, len, maxId, maxType, meta, metaTags, passesFilter, tag, tagFilters, type;
...
tudor.add([
  "05 Listag::browse()", tudor.is, "`browse()` is a function which returns a string or an array", function() {
  ...
  }, "For a populated Listag instance, `browse()` returns a table, as a string", "i..id.......type.....aa..bbbb\n1  the_1st  boolean  1   1   ", function(listag) {
    listag.add(true, 'the_1st', ['aa', 'bbbb']);
    return listag.browse();
  }, "The `config` argument accepts an object as expected", "Empty object", "i..id..........type.....aa..bbbb..ccc\n1  the_1st     boolean  1   1        \n2  the_second  number       2     1  \n3  third       array                 \n4  fourth      regexp             2  ", function(listag) {
    listag.add(222, 'the_second', ['bbbb', 'ccc']);
    listag.add([3], 'third');
    listag.add(/4/, 'fourth', ['ccc']);
    return listag.browse({});
  }, "Can contain arbitrary properties", "i..id..........type.....aa..bbbb..ccc\n1  the_1st     boolean  1   1        \n2  the_second  number       2     1  \n3  third       array                 \n4  fourth      regexp             2  ", function(listag) {
    return listag.browse({
      a: 1,
      '-!•': 'ok'
    });
  }, "Can be `null`", "i..id..........type.....aa..bbbb..ccc\n1  the_1st     boolean  1   1        \n2  the_second  number       2     1  \n3  third       array                 \n4  fourth      regexp             2  ", function(listag) {
  ...
  }, "`config.format` usage", tudor.equal, "The string 'text'", "i..id..........type....bbbb..ccc\n1  the_second  number  1     1  \n2  third       array            \n3  fourth      regexp        2  ", function(listag) {
    listag["delete"]('the_1st');
    return listag.browse({
      format: 'text'
    });
  }, "The string 'array'", "{\"i\":1,\"id\":\"the_second\",\"tags\":{\"bbbb\":\"1\",\"ccc\":\"1\",\"node\":\"1\"},\"type\":\"number\"}\n{\"i\":2,\"id\":\"third\",\"tags\":{\"node\":\"2\"},\"type\":\"array\"}\n{\"i\":3,\"id\":\"fourth\",\"tags\":{\"ccc\":\"2\",\"node\":\"3\"},\"type\":\"regexp\"}", function(listag) {
    var node, nodes, out;
    nodes = listag.browse({
      format: 'array'
    });
  ...
  }, "`config.tags` usage", tudor.equal, "An empty array", "i..id..........type....bbbb..ccc\n1  the_second  number  1     1  \n2  third       array            \n3  fourth      regexp        2  ", function(listag) {
    return listag.browse({
      tags: []
    });
  }, "A single tag, text format", "i..id..........type....bbbb..ccc\n1  the_second  number  1     1  \n3  fourth      regexp        2  ", function(listag) {
    listag.add(true, 'the_1st', ['aa', 'bbbb']);
    return listag.browse({
      tags: ['ccc']
    });
  }, "A single tag, array format", "{\"i\":1,\"id\":\"the_second\",\"tags\":{\"bbbb\":\"1\",\"ccc\":\"1\",\"node\":\"1\"},\"type\":\"number\"}\n{\"i\":3,\"id\":\"fourth\",\"tags\":{\"ccc\":\"2\",\"node\":\"2\"},\"type\":\"regexp\"}", function(listag) {
    var node, nodes, out;
    nodes = listag.browse({
      tags: ['ccc'],
      format: 'array'
    ...
    return out.join('\n');
  }, "Two tags, text format", "i..id..........type.....aa..bbbb..ccc\n1  the_second  number       1     1  \n3  fourth      regexp             2  \n4  the_1st     boolean  1   2        ", function(listag) {
    return listag.browse({
      tags: ['aa', 'ccc']
    });
  }, "Two tags, array format", "{\"i\":1,\"id\":\"the_second\",\"tags\":{\"bbbb\":\"1\",\"ccc\":\"1\",\"node\":\"1\"},\"type\":\"number\"}\n{\"i\":3,\"id\":\"fourth\",\"tags\":{\"ccc\":\"2\",\"node\":\"2\"},\"type\":\"regexp\"}\n{\"i\":4,\"id\":\"the_1st\",\"tags\":{\"aa\":\"1\",\"bbbb\":\"2\",\"node\":\"3\"},\"type\":\"boolean\"}", function(listag) {
    var node, nodes, out;
    nodes = listag.browse({
      tags: ['aa', 'ccc'],
      format: 'array'
    ...
    return out.join('\n');
  }, "Tag which does not exist, text format", '[no matches]', function(listag) {
    return listag.browse({
      tags: ['non_existant']
    });
  }, "Tag which does not exist, array format", 0, function(listag) {
    var nodes;
    nodes = listag.browse({
      tags: ['non_existant'],
      format: 'array'
...
tudor.add([
  "06 Listag::edit()", tudor.is, "`edit()` is a function which returns a string", function() {
    ...
    listag.edit('the_first', {});
    return listag.read('the_first');
  }, "`config.cargo` can be changed to `undefined`", "i..id.........type.....\n1  the_first  undefined", function(listag) {
    listag.edit('the_first', {
      cargo: void 0
    });
    return listag.browse();
  ...
  }, "Removal of a single tag - was `['aa', 'bb']`, now `['bb']`", "i..id.........type....bb\n1  the_first  number  1 \nnode:1 aa:0 bb:1 cc:0", function(listag) {
    listag.edit('the_first', {
      tags: ['bb']
    });
    return listag.browse() + '\n' + 'node:' + listag.total.node + ' aa:' + (listag.total.aa || 0) + ' bb:' + (listag.total.bb || 0) + ' cc:' + (listag.total.cc || 0);
  }, "Without a `config.tags` property (but changing cargo), tags do not change", "i..id.........type....bb\n1  the_first  string  1 \nnode:1 aa:0 bb:1 cc:0", function(listag) {
    listag.edit('the_first', {
      cargo: 'ok'
    });
    return listag.browse() + '\n' + 'node:' + listag.total.node + ' aa:' + (listag.total.aa || 0) + ' bb:' + (listag.total.bb || 0) + ' cc:' + (listag.total.cc || 0);
  }, "With an empty `config.tags` array (but changing cargo), no tags remain", "i..id.........type..\n1  the_first  number\nnode:1 aa:0 bb:0 cc:0", function(listag) {
    listag.edit('the_first', {
      cargo: 123,
      tags: []
    });
    return listag.browse() + '\n' + 'node:' + listag.total.node + ' aa:' + (listag.total.aa || 0) + ' bb:' + (listag.total.bb || 0) + ' cc:' + (listag.total.cc || 0);
  }, "An array with arbitrary properties - also, added another node", "i..id..........type....aa..bb..cc\n1  the_first   number  1   1     \n2  the_second  number  2       1 \nnode:2 aa:2 bb:1 cc:1\n\nhead.node: the_first\ntail.node: the_second\nhead.aa:   the_first\ntail.aa:   the_second\nhead.bb:   the_first\ntail.bb:   the_first\nhead.cc:   the_second\ntail.cc:   the_second\n\nhead.node.next.aa:     the_second\ntail.node.next.aa:     null\nhead.node.previous.aa: null\ntail.node.previous.aa: the_first\nhead.node.next.bb:     null\ntail.node.next.bb:     undefined\nhead.node.previous.bb: null\ntail.node.previous.bb: undefined\nhead.node.next.cc:     undefined\ntail.node.next.cc:     null\nhead.node.previous.cc: undefined\ntail.node.previous.cc: null" + '\n', function(listag) {
    var summary, tags;
    summary = function(node) {
      return (node ? node.id : node) + '\n';
    };
